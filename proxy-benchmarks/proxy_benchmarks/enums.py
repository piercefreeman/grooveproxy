...
class TLSKnownExtensionEnum(Enum):
    """
    Enum of TLS extensions. The extensive list is located:
    ...
    # Connection ID was also 53 - but this is deprecated
    CONNECTION_ID = 54
    EXTERNAL_ID_HASH = 55
...
class CipherEnum(Enum):
    """
    Enum of TLS cipher suites. The extensive list is located:
